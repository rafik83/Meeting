...
class SheetValidationDraftMail extends Mail
{
     ...
     * @var string
     */
    protected $subject = 'mail.sheet.validation.draft.subject';

    /**
     * @var string
     */
    protected $template = 'MailBundle:Mail:Sheet/sheetValidationDraft.html.twig';

    /**
     * @var string
     */
    protected $messageId = Events::SHEET_VALIDATION_DRAFT;
