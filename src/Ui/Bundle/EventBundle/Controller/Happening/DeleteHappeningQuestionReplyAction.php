...
class DeleteHappeningQuestionReplyAction
{
    ...
    public function __invoke(
        ...
        try {
            $this->commandBus->handle(new DeleteHappeningQuestionReply($questionId, $user));
        } catch(QuestionNotFoundException $e) {
            return new JsonResponse(['status' => 'error', 'message' => $e->getMessage()], 404);
        } catch(DeleteQuestionReplyNotAllowedException $e) {
