...
class ExportController extends Controller
{
     ...
     */
    public function exportFileAction(Event $event, $hash, File $file): CsvFileResponse
    {
        $this->denyAccessUnlessGranted('PERMISSION_EVENT_ACCESS', $event);
        $this->denyAccessUnlessGranted('ROLE_ALLOWED_TO_ORGANIZE');
        ...
        $path = sprintf('%s%s', $this->getParameter('infrastructure.export_products_path'), $file->getPath());
