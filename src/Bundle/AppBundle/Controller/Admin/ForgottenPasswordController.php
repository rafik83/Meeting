...
use Proximum\Vimeet\Bundle\AppBundle\Form\Type\Admin\ForgottenPasswordType;
...
class ForgottenPasswordController extends Controller
{
    ...
    public function forgottenPasswordAction(Request $request)
    {
        ...
        return $this->render('VimeetAppBundle:Admin/ResetPassword:request_token.html.twig', [
    ...
    public function createNewPasswordAction(Request $request, ForgottenPasswordToken $forgottenPasswordToken)
    {
        ...
        return $this->render('VimeetAppBundle:Admin/ResetPassword:new_password.html.twig', [
            'form' => $form->createView(),
        ]);
    }
}
