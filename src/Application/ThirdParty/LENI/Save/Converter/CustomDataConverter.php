...
class CustomDataConverter
{
     ...
     *              example: ['sheet_organization_staff' => 'ZL_Effectif', 'sheet_generic_tag_20' => 'ZL_TypePrestation']
     * @param array $taggedData data indexed by tag,
     *              example: ['sheet_organization_staff' => 'A1', 'sheet_generic_tag_20' => ['P12', 'P3', 'P5']]
     *
     * @return array indexed by LENI field
     *               exemple: ['ZL_Effectif' => 'A1', 'ZL_TypePrestation' => ['P12', 'P3', 'P5']]
     */
