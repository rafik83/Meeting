...
class Version20170222084853 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, sheet_id INT DEFAULT NULL, total DOUBLE PRECISION NOT NULL, total_with_vat DOUBLE PRECISION NOT NULL, vat_amount DOUBLE PRECISION NOT NULL, number VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_9065174471F7E88B (event_id), INDEX IDX_906517448B1206A5 (sheet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
