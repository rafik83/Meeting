...
class Version20170727141842 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE video_conference_token (id INT AUTO_INCREMENT NOT NULL, video_conference_id INT DEFAULT NULL, token LONGTEXT NOT NULL, INDEX IDX_F8A970556B31AFB2 (video_conference_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
