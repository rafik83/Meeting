...
class Version20170504114616 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE sheet_viewed (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, sheet_id INT DEFAULT NULL, created_at DATETIME NOT NULL, INDEX IDX_58E1575AA76ED395 (user_id), INDEX IDX_58E1575A8B1206A5 (sheet_id), UNIQUE INDEX unique_user_sheet (user_id, sheet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
