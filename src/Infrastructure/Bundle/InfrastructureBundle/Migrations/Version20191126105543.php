...
/**
 * Add previous_answer to question
 */
class Version20191126105543 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');

        $this->addSql('ALTER TABLE registration_path_question ADD previous_answer_id INT NOT NULL');
