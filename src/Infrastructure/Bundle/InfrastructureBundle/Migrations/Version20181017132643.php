...
class Version20181017132643 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE static_formulation (id INT AUTO_INCREMENT NOT NULL, event_id INT DEFAULT NULL, `key` VARCHAR(255) NOT NULL, INDEX IDX_142B003A71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
