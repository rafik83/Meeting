 ...
 */
class Version20181217143144 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE user_event_presence_date (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, event_id INT NOT NULL, arrival DATETIME NOT NULL, departure DATETIME NOT NULL, INDEX IDX_4FFDF0DDA76ED395 (user_id), INDEX IDX_4FFDF0DD71F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
