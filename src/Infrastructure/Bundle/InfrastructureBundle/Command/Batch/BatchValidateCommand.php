...
class BatchValidateCommand extends Command
{
    const NAME = 'vimeet:sheets:validate';
    ...
    /**
     * @var PostBatchValidateHandler
     */
    private $postBatchValidateHandler;

    /**
     * @param AdminRepositoryInterface $adminRepository
     * @param SheetRepositoryInterface $sheetRepository
     * @param PostBatchValidateHandler $postBatchValidateHandler
     */
    public function __construct(
        AdminRepositoryInterface $adminRepository,
        SheetRepositoryInterface $sheetRepository,
        PostBatchValidateHandler $postBatchValidateHandler
    ) {
        parent::__construct(self::NAME);

        $this->adminRepository          = $adminRepository;
        $this->sheetRepository          = $sheetRepository;
        $this->postBatchValidateHandler = $postBatchValidateHandler;
    }
