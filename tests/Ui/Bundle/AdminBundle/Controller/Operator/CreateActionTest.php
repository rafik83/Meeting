...
use Proximum\Vimeet\Ui\Bundle\AdminBundle\Controller\Operator\CreateAction;
...
class CreateActionTest extends TestCase
{
    ...
    public function testAuthorization(): void
    {
        ...
        $action($this->request->reveal(), new AdminDomain($this->admin->reveal()));
    }
    ...
    public function testInvoke(): void
    {
        ...
        $this->formFactory
            ->create(CreateType::class, Argument::type(Create::class), ['submit' => true, 'events' => $events])
            ->shouldBeCalled()
            ->willReturn($form)
        ;

        $this->engine
            ->render('AdminBundle:Operator:create.html.twig', ['form' => $view])
            ->shouldBeCalled()
    ...
    public function testHandle(): void
    {
        ...
        $this->admin->getEvents()->shouldBeCalled()->willReturn($events);
        $form = $this->prophesize(Form::class);
        $this->formFactory->create(CreateType::class, Argument::type(Create::class), ['submit' => true, 'events' => $events])
            ->shouldBeCalled()
            ->willReturn($form)
        ;
        ...
        $this->flashBag
            ->add('success', 'flash.admin.operator.create.success')
            ->shouldBeCalled()
        ;
