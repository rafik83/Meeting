...
use Proximum\Vimeet\Ui\Bundle\AdminBundle\Controller\Partner\CreateAction;
...
class CreateActionTest extends TestCase
{
    ...
    public function testInvoke(): void
    {
        ...
        $this->formFactory
            ->create(CreateType::class, Argument::type(Create::class), ['submit' => true, 'events' => $events, 'locale' => 'fr'])
            ->shouldBeCalled()
            ->willReturn($form)
        ;

        $this->twig
            ->render('AdminBundle:Partner:create.html.twig', ['form' => $view, 'isSuperAdmin' => true])
            ->shouldBeCalled()
    ...
    public function testHandle(): void
    {
        ...
        $this->flashBag
            ->add('success', 'flash.admin.partner.create.success')
            ->shouldBeCalled()
        ;

        $this->twig
            ->render('AdminBundle:Partner:create.html.twig', Argument::any())
            ->shouldNotBeCalled()
        ;
