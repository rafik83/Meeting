...
class OrdersToInvoiceTest extends \PHPUnit_Framework_TestCase
{
    public function testGetInvoiceViewForSheet()
    {
        ...
        $expectedOrdersToInvoiceView = new OrdersToInvoiceView([$orderOne, $orderTwo], [], 2564, 512.8, 3076.8);

        $this->assertEquals($ordersToInvoiceView, $expectedOrdersToInvoiceView);
    }
