...
class ProductByParticipantGetterTest extends TestCase
{
    public function testGetFromCartWithSeveralProductsAndNoAssignedProduct()
    {
        ...
        $package->getParticipants()->shouldBeCalled()->willReturn([$product1->reveal(), $product2->reveal()]);
    ...
    public function testGetFromCartWithOneProduct()
    {
        ...
        $package = $this->prophesize(Package::class);
        $package->getParticipants()->shouldBeCalled()->willReturn([$product1->reveal()]);
        ...
        $expectedResult = [42 => $product1->reveal(), 2000 => $product1->reveal()];
