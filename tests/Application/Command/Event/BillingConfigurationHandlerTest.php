...
class BillingConfigurationHandlerTest extends TestCase
{
    public function testHandle()
    {
        ...
        $event->getConfiguration()->setColors('#FFFFFF', '#000000', '#CCCCCC', '#CCCCCC', '#CCCCCC', '#CCCCCC');
        ...
        $expectedEvent->getConfiguration()->setColors('#FFFFFF', '#000000', '#CCCCCC', '#CCCCCC', '#CCCCCC', '#CCCCCC');
