...
class ApproveRequestHandlerTest extends TestCase
{
    public function testHandle()
    {
        ...
        $allowTransformRequestIntoMeetingOnDday = $this->prophesize(AllowTransformRequestIntoMeetingOnDday::class);
        $allowTransformRequestIntoMeetingOnDday->__invoke()->shouldNotBeCalled();
        ...
        $handler = new ApproveRequestHandler(
            $allowTransformRequestIntoMeetingOnDday->reveal(),
