...
class ParticipantListViewNormalizerTest extends TestCase
{
    public function testNormalize()
    {
        ...
        $expected = "sheet_id,participant_type,sheet_name,sheet_enable,user_id,participant_id,participant_email,"
                   ...
                   . "clicked_elements,requested_meetings,scheduled_meetings,chat_sessions_call_visio,"
...
admin.participant.export.fields.sheet_id,admin.participant.export.fields.participant_type,"
                   ...
                   . "admin.participant.export.fields.chat_sessions_call_visio,"
...
124,typeTitle1,sheetTitle1,admin.participant.export.yes,1244,12445,email1@example.net,10/10/2017,admin.participant.export.yes,admin.participant.export.fields.participation_paid.paid,5,6,7,8,9,content1,,,,,,,content8,,admin.participant.export.no,admin.participant.export.no,admin.participant.export.yes,admin.participant.export.no,admin.participant.export.no,admin.participant.export.yes,admin.participant.export.no
123,typeTitle1,sheetTitle1,admin.participant.export.yes,1234,12345,email1@example.net,10/10/2017,admin.participant.export.yes,admin.participant.export.fields.participation_paid.paid,4,3,2,1,0,content1,content2,content4,,,,,,\"10/10/2018 10:00\",admin.participant.export.no,admin.participant.export.yes,admin.participant.export.yes,admin.participant.export.yes,admin.participant.export.no,admin.participant.export.no,admin.participant.export.no
";
