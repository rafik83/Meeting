...
class SpotSatisfactionListViewDenormalizerTest extends TestCase
{
    public function testDenormalize()
    {
        ...
        $expected->addSpotSatisfaction(new SpotSatisfactionView(301, 'MTable A01', true, false, 92));
        $expected->addSpotSatisfaction(new SpotSatisfactionView(302, 'MTable A02', true, false, 100));
        $expected->addSpotSatisfaction(new SpotSatisfactionView(303, 'MTable A03', true, false, 92));
        $expected->addSpotSatisfaction(new SpotSatisfactionView(310, 'MTable B01', false, false, 57));
        $expected->addSpotSatisfaction(new SpotSatisfactionView(311, 'MTable B02', true, false, 71));
        $expected->addSpotSatisfaction(new SpotSatisfactionView(312, 'MTable B03', true, true, 71));
