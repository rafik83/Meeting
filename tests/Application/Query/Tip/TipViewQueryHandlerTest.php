...
class TipViewQueryHandlerTest extends TestCase
{
    public function testHandle()
    {
        ...
        $tip1 = new Tip('tip_1', null, false, true, false, false, false, false, false, $dateTime);
        $tip2 = new Tip('tip_2', null, false, true, false, false, false, false, false, $dateTime);
        $tip3 = new Tip('tip_3', null, false, true, false, false, false, false, false, $dateTime);
