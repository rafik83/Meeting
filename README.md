...
8. Add a new branch, commit and push `git checkout -b migrations/VersionYYYYMMDDHHMMSS && git add . F&& git commit -m "Add migrations" && git push origin migrations/VersionYYYYMMDDHHMMSS`
