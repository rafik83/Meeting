Feature: Forgot Password Admin
  ...
  Scenario: I can not request a token for a non-existent account
    ...
    And I should be on this page "/admin/fr/forgot-password"
  ...
  Scenario: I can request a token for an existent account and change the password
    ...
    And the "admin_forgot_password" mail should contain the link "http://vimeet.proximum.dev/app_test.php/admin/fr/reset-password/"
    And I follow the "http://vimeet.proximum.dev/app_test.php/admin/fr/reset-password/" link in the "admin_forgot_password" mail
