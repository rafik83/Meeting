Feature: Forgot Password Admin
  ...
  Scenario: I can not request a token for a non-existent account
    ...
    And I should be on this page "http://vimeet.proximum.dev/app_test.php/admin/forgot-password"
  ...
  Scenario: I can request a token for an existent account and change the password
    ...
    And I press "form.forgotten_password.children.submit.label"
    And I should be on this page "http://vimeet.proximum.dev/app_test.php/admin/login"
    And I should see "flash.admin.reset_password_token.success"
    And the "admin_forgot_password" mail should be sent to "test@test.com"
    And the "admin_forgot_password" mail should contain the link "http://vimeet.proximum.dev/app_test.php/admin/reset-password/"
    And I follow the "http://vimeet.proximum.dev/app_test.php/admin/reset-password/" link in the "admin_forgot_password" mail
