Feature: Pro-forma
  ...
  Scenario: I can see a valid pro-forma
    ...
    And the response status code should be 200
    Then I go to "http://rdv-carnot-2016.vimeet.proximum.dev/app_test.php/fr/sheet/2/final"
    And the response status code should be 200
    Then I follow "event.sheet.billing.proForma"
    And I should be on "http://rdv-carnot-2016.vimeet.proximum.dev/app_test.php/fr/sheet/2/pro_forma"
    And the response status code should be 200
