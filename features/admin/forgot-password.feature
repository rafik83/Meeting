...
Feature: Forgot Password Admin
  ...
  Scenario: I can request a token for an existent account and change the password
    ...
    And the "admin.password_reset" mail should contain the link "http://vimeet.proximum.dev/app_test.php/fr/reset-password/"
    And I follow the "http://vimeet.proximum.dev/app_test.php/fr/reset-password/" link in the "admin.password_reset" mail
