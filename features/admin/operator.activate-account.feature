...
Feature: Operator Activate Account
  ...
  Scenario: I can add an operator and activate the account
    ...
    And the "admin.account_activated" mail should contain the link "http://vimeet.proximum.dev/app_test.php/fr/activate-account"
    Then I follow the "http://vimeet.proximum.dev/app_test.php/fr/activate-account" link in the "admin.account_activated" mail
