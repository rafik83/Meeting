...
Feature: Forgot Password
  ...
  Scenario: I can not request a token for a non-existent account
    ...
    When I go to this page "http://rdv-carnot-2016.vimeet.proximum/app_test.php/fr/forgotten_password"
  ...
  Scenario: I can request a token for an existent account and change the password
    When I go to "http://rdv-carnot-2016.vimeet.proximum/app_test.php/fr/forgotten_password"
    And I fill in "form.forgotten_password.children.email.label" with "test@test.com"
    And I press "form.forgotten_password.children.submit.label"
    And I should be on this page "http://rdv-carnot-2016.vimeet.proximum/app_test.php/fr/forgotten_password/confirm"
    And the "user.password_reset" mail should be sent to "test@test.com" from "no-reply@rdv-carnot-2016.vimeet.proximum"
    And the "user.password_reset" mail should contain the link "http://rdv-carnot-2016.vimeet.proximum/app_test.php/fr/reset_password/"
    And I follow the "http://rdv-carnot-2016.vimeet.proximum/app_test.php/fr/reset_password/" link in the "user.password_reset" mail
