...
@sheet
@catalog
Feature: Search sheet by position
  ...
  Scenario: I can search and filter sheet by catalog by position
    ...
    When I go to this page "/fr/catalog?type%5B%5D=1&type%5B%5D=2&type%5B%5D=3&position%5B%5D=position35&orderBy=alphabetical"
    Then I should see "Elao"
